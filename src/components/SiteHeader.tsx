...
interface SiteHeaderProps {
  theme: Theme;
  current: "atlas" | "paths" | "autograd" | "gradient" | "adamw" | "gpu-architecture" | "cuda-kernel" | "cuda-stream" | "process-rank" | "collective" | "ring-allreduce" | "ddp" | "zero-1" | "fsdp" | "compare" | "other";
  onToggleTheme: () => void;
}
