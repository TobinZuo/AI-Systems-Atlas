...
export const scenarioRegistry: ScenarioRegistration[] = [
  {
    ...
    evidence: ["deterministic simulator", "numeric invariants", "Chrome Trace"],
    status: "available",
  ...
  },
  {
    ...
    evidence: ["ownership invariants", "state-dict contract", "smoke test"],
    status: "available",
  ...
  },
  {
    ...
    evidence: ["shard invariants", "memory lifecycle", "collective contract"],
    status: "available",
